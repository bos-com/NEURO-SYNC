export { default } from "./BrainAnimationClean";
      <motion.div
        ...
        className="w-40 h-40 bg-gradient-to-tr from-cyan-500 to-blue-700 rounded-full flex items-center justify-center text-5xl font-bold text-white"
      >
        🌀
      </motion.div>
      <p className="mt-4 text-gray-400 text-sm">Analyzing voice emotions...</p>
    </div>
  );
}
